...
CREATE TABLE `veterinaria` (
  ...
  `tipo_vac` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `nombre_vet` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `id_dueño` int(12) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
...
--
ALTER TABLE `fecha_vacunacion`
  ADD CONSTRAINT `fecha_vacunacion_ibfk_1` FOREIGN KEY (`id_vet`) REFERENCES `veterinaria` (`id_vet`);
...
--
ALTER TABLE `veterinaria`
  ADD CONSTRAINT `veterinaria_ibfk_1` FOREIGN KEY (`id_dueño`) REFERENCES `dueño` (`id_dueño`);
COMMIT;
